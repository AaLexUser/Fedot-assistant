...
class PromptGenerator(ABC):
    ...
    def system_prompt(self):
        return ("You are an expert assistant that parses information about data science tasks,"
...
class DescriptionFileNamePromptGenerator(PromptGenerator):
    ...
    def generate_prompt(self) -> str:
        ...
        file_content_prompts += ("Please return the full path of the file to describe the problem settings, "
...
class DataFileNamePromptGenerator(PromptGenerator):
    ...
    def generate_prompt(self) -> str:
        ...
        file_content_prompts += (f"Based on the data description, what are the training, test, and output data? "
