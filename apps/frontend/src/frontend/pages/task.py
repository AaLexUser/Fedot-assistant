...
from shared.constants import AUTOML_ENGINE_OPTIONS, TIME_LIMIT_MAPPING
...
from frontend.log_processor import messages, show_logs
...
def setup_local_dataset():
    ...
    try:
        ...
        Path(LOCAL_ZIP_PATH).parent.mkdir(parents=True, exist_ok=True)
