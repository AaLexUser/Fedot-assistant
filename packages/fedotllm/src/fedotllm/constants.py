...
TIME_SERIES = "time_series"
PROBLEM_TYPES = [BINARY, MULTICLASS, MULTILABEL, REGRESSION, TIME_SERIES]
CLASSIFICATION_PROBLEM_TYPES = [BINARY, MULTICLASS, MULTILABEL]
...
PRESETS = [MEDIUM_QUALITY, BEST_QUALITY]
...
METRICS_BY_PROBLEM_TYPE = {
    ...
    MULTILABEL: [ROC_AUC, LOG_LOSS, ACCURACY, F1, BALANCED_ACCURACY],
    REGRESSION: [
